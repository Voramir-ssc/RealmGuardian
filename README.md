...
![Version](https://img.shields.io/badge/version-v.0.5.1-blue.svg)
...
## Current Working Status (v.0.5.1)
...
- [x] **Historische Gold-Charts:** Tägliche Snapshots des Account-übergreifenden Goldes mit visueller Darstellung.
- [x] **Item Level (iLvl) & Ausrüstung:** Detaillierte Ansicht der angelegten Ausrüstung und Item-Level pro Charakter.
- [x] **Berufe:** Übersicht der Berufe und Skill-Level der Charaktere.

---

> **Note for AI Agents & Developers:**
> The core login, OAuth, and Battle.net token synchronization loops are currently *robust and functioning correctly* as of `v.0.5.1` (with `v.0.4.4` serving as a known stable rollback snapshot). Do not heavily modify the core `blizzard_api.py` authentication logic or the recursive callback loops in `main.py` without extremely careful consideration.
